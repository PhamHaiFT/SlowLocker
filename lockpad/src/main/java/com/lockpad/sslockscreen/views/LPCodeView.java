package com.lockpad.sslockscreen.views;
...
public class LPCodeView extends LinearLayout {
    ...
    public LPCodeView(Context context) {
        super(context);
        init();
    }

    public LPCodeView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public LPCodeView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
