...
public class LPFingerprintUIHelper extends FingerprintManagerCompat.AuthenticationCallback {
    ...
    private final LPFingerprintAuthListener mCallback;
    private CancellationSignal mCancellationSignal;

    private boolean mSelfCancelled;

    public LPFingerprintUIHelper(FingerprintManagerCompat fingerprintManager,
                                 ImageView icon, TextView errorTextView,
                                 LPFingerprintAuthListener callback) {
        super();
