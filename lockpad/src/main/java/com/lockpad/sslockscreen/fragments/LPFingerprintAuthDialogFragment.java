...
public class LPFingerprintAuthDialogFragment extends DialogFragment {
    ...
    private LPFingerprintUIHelper mFingerprintCallback;

    private Context mContext;

    private LPFingerprintAuthListener mAuthListener;
    ...
    public void setAuthListener(LPFingerprintAuthListener authListener) {
