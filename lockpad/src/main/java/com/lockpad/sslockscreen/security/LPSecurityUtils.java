...
public class LPSecurityUtils implements IPFSecurityUtils {

    private static final LPSecurityUtils ourInstance = new LPSecurityUtils();

    public static LPSecurityUtils getInstance() {
        return ourInstance;
    }

    private LPSecurityUtils() {

    }

    private KeyStore loadKeyStore() throws LPSecurityException {
        try {
            ...
            return keyStore;
                ...
                | IOException e) {
            e.printStackTrace();
            throw new LPSecurityException(
                    "Can not load keystore:" + e.getMessage(),
                    LPSecurityUtilsErrorCodes.ERROR_LOAD_KEY_STORE
            );
        }
    }
    ...
    public String encode(@NonNull Context context, String alias, String input, boolean isAuthorizationRequared)
        ...
        try {
            ...
            throw new LPSecurityException(
                    ...
                    LPSecurityUtilsErrorCodes.ERROR_ENCODING
            );
        }
    }
    ...
    private String decode(String encodedString, Cipher cipher) throws LPSecurityException {
        try {
            ...
            throw  new LPSecurityException(
                    ...
                    LPSecurityUtilsErrorCodes.ERROR_DE_ENCODING
            );
        }
    }

    @Override
    public String decode(String alias, String encodedString) throws LPSecurityException {
        try {
            final Cipher cipher = getCipherInstance();
    ...
    private Cipher getCipherInstance() throws LPSecurityException {
        try {
            ...
            throw new LPSecurityException(
                    ...
                    LPSecurityUtilsErrorCodes.ERROR_GET_CIPHER_INSTANCE
            );
        }
    }


    private void initDecodeCipher(Cipher cipher, String alias) throws LPSecurityException {
        try {
            final KeyStore keyStore = loadKeyStore();
            ...
            throw  new LPSecurityException(
                    ...
                    LPSecurityUtilsErrorCodes.ERROR_INIT_DECODE_CIPHER
            );
        }
    ...
    private void initEncodeCipher(Cipher cipher, String alias, KeyStore keyStore)
        ...
        try {
            ...
            throw new LPSecurityException(
                    ...
                    LPSecurityUtilsErrorCodes.ERROR_INIT_END_DECODE_CIPHER
            );
        }
    }

    @Override
    public boolean isKeystoreContainAlias(String alias) throws LPSecurityException {
        final KeyStore keyStore = loadKeyStore();
        try {
            ...
            throw new LPSecurityException(
                    e.getMessage(),
                    LPSecurityUtilsErrorCodes.ERROR_KEY_STORE
            );
        }
    }

    @Override
    public void deleteKey(String alias) throws LPSecurityException {
        final KeyStore keyStore = loadKeyStore();
        try {
            ...
            throw new LPSecurityException(
                    ...
                    LPSecurityUtilsErrorCodes.ERROR_DELETE_KEY
            );
        }
    }
