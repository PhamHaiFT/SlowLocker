...
public class LPSecurityUtilsOld implements IPFSecurityUtils {

    private static final LPSecurityUtilsOld ourInstance = new LPSecurityUtilsOld();

    public static LPSecurityUtilsOld getInstance() {
        return ourInstance;
    }

    private LPSecurityUtilsOld() {
