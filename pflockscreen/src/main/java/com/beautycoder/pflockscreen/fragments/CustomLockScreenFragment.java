...
public class CustomLockScreenFragment extends Fragment {

    private static final String TAG = CustomLockScreenFragment.class.getName();
    ...
    private PFCodeView mPinCodeView;
    ...
    private final PFCodeView.OnPFCodeListener mEnterCodeListener = new PFCodeView.OnPFCodeListener() {
        @Override
