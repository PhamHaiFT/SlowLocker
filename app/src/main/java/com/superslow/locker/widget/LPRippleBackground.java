package com.superslow.locker.widget;
...
public class LPRippleBackground extends RelativeLayout {
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        rippleColor = typedArray.getColor(R.styleable.RippleBackground_rb_color, getResources().getColor(R.color.common_white));
        ...
        for (int i = 0; i < rippleAmount; i++) {
            ...
            final ObjectAnimator alphaAnimator = ObjectAnimator.ofFloat(rippleView, "Alpha", 0.1f, 1.0f, 0.4f, 0.1f);
